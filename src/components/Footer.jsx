            ...
            <div className="container">
                <div className="footer-top">
                    ...
                    <div className="footer-legal-links">
                        <a href={agentInfo.docs?.consumerProtection || "https://www.trec.texas.gov/sites/default/files/pdf-forms/CN%201-5_0.pdf"} target="_blank" rel="noopener noreferrer">Texas Real Estate Commission Consumer Protection Notice</a>
                        <a href={agentInfo.docs?.iabs || "https://www.trec.texas.gov/sites/default/files/pdf-forms/IABS%201-0.pdf"} target="_blank" rel="noopener noreferrer">Texas Real Estate Commission Information About Brokerage Services</a>
                        <a href={agentInfo.docs?.disclaimer || "#"} target="_blank" rel="noopener noreferrer" className="legal-modal-trigger">TREC Disclaimer</a>
                    </div>
